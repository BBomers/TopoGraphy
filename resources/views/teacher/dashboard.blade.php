...
<x-app-layout>
    ...
    <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
        ...
        {{-- Your Students --}}
        <div class="bg-white your-students dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
    ...
    @forelse($yourStudents as $student)
        ...
        <div>    
            ...
            <form action="{{ route('teacher.removeStudent', $student->id) }}" method="POST">
                            @csrf
                            <button
                                type="submit"
